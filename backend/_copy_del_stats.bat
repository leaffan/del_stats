...
echo + Copying shots data...
copy data\%SEASON%\del_shots.csv %TGT_BASE_DIR%\%SEASON%
echo + Copying top and bottom individual game scores...
copy data\%SEASON%\del_game_scores_per_game_top.json %TGT_BASE_DIR%\%SEASON%
copy data\%SEASON%\del_game_scores_per_game_bottom.json %TGT_BASE_DIR%\%SEASON%
